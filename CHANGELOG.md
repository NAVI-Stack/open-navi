...
## 0.1.0 - Initial open-navi package release

- Rename the public npm and PyPI package identity to `open-navi`.
- Preserve the installed CLI command as `navi` and the Python import package as `navi`.
